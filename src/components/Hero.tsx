                        ...
                        <div className="relative bg-n-8 rounded-[1rem]">
                            ...
                            <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                                ...
                                <ScrollParallax isAbsolutelyPositioned>
                                    <ul className="hidden absolute -left-[5.5rem] -left=[5.5rem] bottom-[7.5rem] px-1 py-1 bg-n-9/40 backdrop-blur border bodrer-n-1/10 rounded-2xl xl:flex">
                                        {
                                ...
                                <ScrollParallax isAbsolutelyPositioned>
                                    <Notifications className={"hidden absolute -right-[5.5rem] bottom-[11rem] w-[18rem] xl:flex"} title={"Code generation"} />
                                </ScrollParallax>
                            </div>
                        </div>
                        <Gradient />
