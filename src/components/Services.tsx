    ...
    return (
        <Section id="how-to-use">
            <div className="container">
                <Heading title="Generative AI made for creators" text="Brainwave unclocks the potetial of AI-powered applications" />
                ...
                <div className="relative">
                    <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border  border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                        ...
                        <Generating className={"absolute left-20 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x-1/2"} />
                    </div>
                    ...
                    <div className="relative z-1 grid gap-5 lg:grid-cols-2">
                        <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                                ...
                                <p className="body-2 mb-[3rem] text-n-3">Automatically enhance your photos using AI app&apos;s photo editing feature. Try it now</p>
                            </div>
                            <PhotoChatMessage />
                        </div>
                            ...
                            <div className="py-12 px-4 xl:px-8">
                                ...
                                <ul className="flex items-center justify-between">
                                    {brainwaveServicesIcons.map((item, index) => (
                                        <li key={index} className={`rounded-2xl flex items-center justify-center ${index === 2 ? "w-[3rem] h-[3rem] p-0.25 bg-conic-gradient rounded-2xl md:w-4.5rem md:h-[4.5rem]" : "flex w-10 h-10 bg-n-6 md:w-15 md:h-15"}`}>
